...
// Draw a color-filled rectangle
void DrawRLRectangleRec(RLRectangle rec, Color color)
{
...
void DrawRectangleLinesEx(RLRectangle rec, float lineThick, Color color)
{
    ...
    DrawRLRectangleRec(top, color);
    DrawRLRectangleRec(bottom, color);
    DrawRLRectangleRec(left, color);
    DrawRLRectangleRec(right, color);
}
