    ...
    while (!WindowShouldClose())    // Detect window close button or ESC key
    {
        ...
        BeginDrawing();
            ...
            for (int i = 0; i < SIZEOF(emoji); ++i)
            {
                ...
                RLRectangle emojiRect = { pos.x, pos.y, (float)fontEmoji.baseSize, (float)fontEmoji.baseSize };
            ...
            if (selected != -1)
            {
                ...
                // Draw chat bubble
                DrawRLRectangleRec(msgRect, emoji[selected].color);
                DrawTriangle(a, b, c, emoji[selected].color);

                // Draw the main text message
                RLRectangle textRect = { msgRect.x + horizontalPadding/2, msgRect.y + verticalPadding/2, msgRect.width - horizontalPadding, msgRect.height };
                ...
                RLDrawText(info, (int)pos.x, (int)pos.y, 10, RAYWHITE);
            }
            //------------------------------------------------------------------------------
