    ...
    while (!WindowShouldClose())
    {
        ...
        BeginDrawing();
            ...
            switch(currentTexture)
            {
                ...
                case 2: RLDrawText("RADIAL GRADIENT", 580, 10, 20, LIGHTGRAY); break;
                case 3: RLDrawText("CHECKED", 680, 10, 20, RAYWHITE); break;
                case 4: RLDrawText("WHITE NOISE", 640, 10, 20, RED); break;
                case 5: RLDrawText("CELLULAR", 670, 10, 20, RAYWHITE); break;
                default: break;
            }
