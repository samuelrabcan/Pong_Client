...
//----------------------------------------------------------------------------------
    ...
    typedef struct Font {
        ...
        RLRectangle *recs;        // Characters rectangles in texture
...
RAYGUIAPI bool GuiWindowBox(RLRectangle bounds, const char *title);                                       // Window Box control, shows a window that can be closed
RAYGUIAPI void GuiGroupBox(RLRectangle bounds, const char *text);                                         // Group Box control with text name
RAYGUIAPI void GuiLine(RLRectangle bounds, const char *text);                                             // Line separator control, could contain text
RAYGUIAPI void GuiPanel(RLRectangle bounds, const char *text);                                            // Panel control, useful to group controls
RAYGUIAPI RLRectangle GuiScrollPanel(RLRectangle bounds, const char *text, RLRectangle content, Vector2 *scroll); // Scroll Panel control

// Basic controls set
RAYGUIAPI void GuiLabel(RLRectangle bounds, const char *text);                                            // Label control, shows text
RAYGUIAPI bool GuiButton(RLRectangle bounds, const char *text);                                           // Button control, returns true when clicked
RAYGUIAPI bool GuiLabelButton(RLRectangle bounds, const char *text);                                      // Label button control, show true when clicked
RAYGUIAPI bool GuiToggle(RLRectangle bounds, const char *text, bool active);                              // Toggle Button control, returns true when active
...
RAYGUIAPI bool GuiCheckBox(RLRectangle bounds, const char *text, bool checked);                           // Check Box control, returns true when active
RAYGUIAPI int GuiComboBox(RLRectangle bounds, const char *text, int active);                              // Combo Box control, returns selected item index
RAYGUIAPI bool GuiDropdownBox(RLRectangle bounds, const char *text, int *active, bool editMode);          // Dropdown Box control, returns selected item
RAYGUIAPI bool GuiSpinner(RLRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);     // Spinner control, returns selected value
RAYGUIAPI bool GuiValueBox(RLRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode);    // Value Box control, updates input text with numbers
RAYGUIAPI bool GuiTextBox(RLRectangle bounds, char *text, int textSize, bool editMode);                   // Text Box control, updates input text
RAYGUIAPI bool GuiTextBoxMulti(RLRectangle bounds, char *text, int textSize, bool editMode);              // Text Box control with multiple lines
RAYGUIAPI float GuiSlider(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);       // Slider control, returns selected value
RAYGUIAPI float GuiSliderBar(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);    // Slider Bar control, returns selected value
RAYGUIAPI float GuiProgressBar(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue);  // Progress Bar control, shows current progress value
RAYGUIAPI void GuiStatusBar(RLRectangle bounds, const char *text);                                        // Status Bar control, shows info text
RAYGUIAPI void GuiDummyRec(RLRectangle bounds, const char *text);                                         // Dummy control for placeholders
RAYGUIAPI Vector2 GuiGrid(RLRectangle bounds, const char *text, float spacing, int subdivs);              // Grid control, returns mouse cell position
...
RAYGUIAPI int GuiListViewEx(RLRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active);      // List View with extended parameters
...
RAYGUIAPI int GuiTextInputBox(RLRectangle bounds, const char *title, const char *message, const char *buttons, char *text, int textMaxSize, int *secretViewActive);   // Text Input Box control, ask for text, supports secret
RAYGUIAPI Color GuiColorPicker(RLRectangle bounds, const char *text, Color color);                        // Color Picker control (multiple color controls)
RAYGUIAPI Color GuiColorPanel(RLRectangle bounds, const char *text, Color color);                         // Color Panel control
RAYGUIAPI float GuiColorBarAlpha(RLRectangle bounds, const char *text, float alpha);                      // Color Bar Alpha control
RAYGUIAPI float GuiColorBarHue(RLRectangle bounds, const char *text, float value);                        // Color Bar Hue control
...
static void SetShapesTexture(Texture2D tex, RLRectangle rec); // -- GuiLoadStyle()
...
static void GuiDrawText(const char *text, RLRectangle bounds, int alignment, Color tint);         // Gui draw text using default font
...
// Window Box control
bool GuiWindowBox(RLRectangle bounds, const char *title)
{
...
void GuiGroupBox(RLRectangle bounds, const char *text)
{
    ...
    // Draw control
    //--------------------------------------------------------------------
    GuiDrawRectangle(RAYGUI_CLITERAL(RLRectangle){ bounds.x, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RLRectangle){ bounds.x, bounds.y + bounds.height - 1, bounds.width, RAYGUI_GROUPBOX_LINE_THICK }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));
    GuiDrawRectangle(RAYGUI_CLITERAL(RLRectangle){ bounds.x + bounds.width - 1, bounds.y, RAYGUI_GROUPBOX_LINE_THICK, bounds.height }, 0, BLANK, Fade(GetColor(GuiGetStyle(DEFAULT, (state == STATE_DISABLED)? BORDER_COLOR_DISABLED : LINE_COLOR)), guiAlpha));
...
// Line control
void GuiLine(RLRectangle bounds, const char *text)
{
...
// Panel control
void GuiPanel(RLRectangle bounds, const char *text)
{
...
RLRectangle GuiScrollPanel(RLRectangle bounds, const char *text, RLRectangle content, Vector2 *scroll)
{
    GuiState state = guiState;
    ...
    RLRectangle horizontalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + verticalScrollBarWidth : (float)bounds.x) + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.y + bounds.height - horizontalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)bounds.width - verticalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)horizontalScrollBarWidth };
    RLRectangle verticalScrollBar = { (float)((GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)? (float)bounds.x + GuiGetStyle(DEFAULT, BORDER_WIDTH) : (float)bounds.x + bounds.width - verticalScrollBarWidth - GuiGetStyle(DEFAULT, BORDER_WIDTH)), (float)bounds.y + GuiGetStyle(DEFAULT, BORDER_WIDTH), (float)verticalScrollBarWidth, (float)bounds.height - horizontalScrollBarWidth - 2*GuiGetStyle(DEFAULT, BORDER_WIDTH) };

    // Calculate view area (area without the scrollbars)
    RLRectangle view = (GuiGetStyle(LISTVIEW, SCROLLBAR_SIDE) == SCROLLBAR_LEFT_SIDE)?
...
// Label control
void GuiLabel(RLRectangle bounds, const char *text)
{
    GuiState state = guiState;
...
bool GuiButton(RLRectangle bounds, const char *text)
{
    GuiState state = guiState;
    bool pressed = false;
...
bool GuiLabelButton(RLRectangle bounds, const char *text)
{
    GuiState state = guiState;
    bool pressed = false;
...
bool GuiToggle(RLRectangle bounds, const char *text, bool active)
{
    GuiState state = guiState;
...
bool GuiCheckBox(RLRectangle bounds, const char *text, bool checked)
{
    GuiState state = guiState;
...
bool GuiDropdownBox(RLRectangle bounds, const char *text, int *active, bool editMode)
{
    GuiState state = guiState;
...
bool GuiTextBox(RLRectangle bounds, char *text, int textSize, bool editMode)
{
    GuiState state = guiState;
    bool pressed = false;
...
bool GuiSpinner(RLRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
    GuiState state = guiState;
...
bool GuiValueBox(RLRectangle bounds, const char *text, int *value, int minValue, int maxValue, bool editMode)
{
    ...
    if (editMode)
    {
        ...
        RLRectangle cursor = { bounds.x + GetTextWidth(textValue)/2 + bounds.width/2 + 2, bounds.y + 2*GuiGetStyle(VALUEBOX, BORDER_WIDTH), 4, bounds.height - 4*GuiGetStyle(VALUEBOX, BORDER_WIDTH) };
...
bool GuiTextBoxMulti(RLRectangle bounds, char *text, int textSize, bool editMode)
{
    ...
    RLRectangle cursor = { 0, -1, 4, (float)GuiGetStyle(DEFAULT, TEXT_SIZE) + 2 };
    ...
    for (int i = 0, codepointLength = 0; text[i] != '\0'; i += codepointLength)
    {
        ...
        RLRectangle atlasRec = guiFont.recs[index];
...
float GuiSliderPro(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue, int sliderWidth)
{
    GuiState state = guiState;
...
float GuiSlider(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    return GuiSliderPro(bounds, textLeft, textRight, value, minValue, maxValue, GuiGetStyle(SLIDER, SLIDER_WIDTH));
}

// Slider Bar control extended, returns selected value
float GuiSliderBar(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    return GuiSliderPro(bounds, textLeft, textRight, value, minValue, maxValue, 0);
}

// Progress Bar control extended, shows current progress value
float GuiProgressBar(RLRectangle bounds, const char *textLeft, const char *textRight, float value, float minValue, float maxValue)
{
    GuiState state = guiState;
...
// Status Bar control
void GuiStatusBar(RLRectangle bounds, const char *text)
{
    GuiState state = guiState;
...
void GuiDummyRec(RLRectangle bounds, const char *text)
{
    GuiState state = guiState;
...
int GuiListViewEx(RLRectangle bounds, const char **text, int count, int *focus, int *scrollIndex, int active)
{
    GuiState state = guiState;
...
// Color Panel control
Color GuiColorPanel(RLRectangle bounds, const char *text, Color color)
{
...
float GuiColorBarAlpha(RLRectangle bounds, const char *text, float alpha)
{
...
float GuiColorBarHue(RLRectangle bounds, const char *text, float hue)
{
    GuiState state = guiState;
...
Color GuiColorPicker(RLRectangle bounds, const char *text, Color color)
{
...
int GuiTextInputBox(RLRectangle bounds, const char *title, const char *message, const char *buttons, char *text, int textMaxSize, int *secretViewActive)
{
    ...
    if (secretViewActive != NULL)
    {
        ...
        *secretViewActive = GuiToggle(RAYGUI_CLITERAL(RLRectangle){ textBoxBounds.x + textBoxBounds.width - RAYGUI_TEXTINPUTBOX_HEIGHT, textBoxBounds.y, RAYGUI_TEXTINPUTBOX_HEIGHT, RAYGUI_TEXTINPUTBOX_HEIGHT }, (*secretViewActive == 1)? "#44#" : "#45#", *secretViewActive);
    }
    else
    {
...
Vector2 GuiGrid(RLRectangle bounds, const char *text, float spacing, int subdivs)
{
    ...
    if (tryBinary)
    {
            ...
            (signature[3] == ' '))
        {
            ...
            if (fontDataSize > 0)
            {
                ...
                fread(&whiteRec, 1, sizeof(RLRectangle), rgsFile);
                ...
                for (int i = 0; i < font.glyphCount; i++) fread(&font.recs[i], 1, sizeof(RLRectangle), rgsFile);
...
static void GuiDrawText(const char *text, RLRectangle bounds, int alignment, Color tint)
{
...
static int GuiScrollBar(RLRectangle bounds, int value, int minValue, int maxValue)
{
    ...
    arrowUpLeft = RAYGUI_CLITERAL(RLRectangle) { (float)bounds.x + GuiGetStyle(SCROLLBAR, BORDER_WIDTH), (float)bounds.y + GuiGetStyle(SCROLLBAR, BORDER_WIDTH), (float)spinnerSize, (float)spinnerSize };
    ...
    if (isVertical)
    {
        ...
        slider = RAYGUI_CLITERAL(RLRectangle) { (float)bounds.x + GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING), (float)scrollbar.y + (int)(((float)(value - minValue)/range)*(scrollbar.height - sliderSize)), (float)bounds.width - 2*(GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING)), (float)sliderSize };
    }
    else
    {
        ...
        slider = RAYGUI_CLITERAL(RLRectangle) { (float)scrollbar.x + (int)(((float)(value - minValue)/range)*(scrollbar.width - sliderSize)), (float)bounds.y + GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING), (float)sliderSize, (float)bounds.height - 2*(GuiGetStyle(SCROLLBAR, BORDER_WIDTH) + GuiGetStyle(SCROLLBAR, SCROLL_SLIDER_PADDING)) };
    }
    ...
    if ((state != STATE_DISABLED) && !guiLocked)
    {
        ...
        if (CheckCollisionPointRec(mousePoint, bounds))
        {
            ...
            else if (IsMouseButtonDown(MOUSE_LEFT_BUTTON))
            {
                if (!isVertical)
                {
                    RLRectangle scrollArea = { arrowUpLeft.x + arrowUpLeft.width, arrowUpLeft.y, scrollbar.width, bounds.height - 2*GuiGetStyle(SCROLLBAR, BORDER_WIDTH) };
                ...
                {
                    RLRectangle scrollArea = { arrowUpLeft.x, arrowUpLeft.y+arrowUpLeft.height, bounds.width - 2*GuiGetStyle(SCROLLBAR, BORDER_WIDTH),  scrollbar.height };
    ...
    {
#if defined(RAYGUI_NO_ICONS)
        GuiDrawText(isVertical ? "^" : "<", RAYGUI_CLITERAL(RLRectangle){ arrowUpLeft.x, arrowUpLeft.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, TEXT + (state*3))), guiAlpha));
        GuiDrawText(isVertical ? "v" : ">", RAYGUI_CLITERAL(RLRectangle){ arrowDownRight.x, arrowDownRight.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(DROPDOWNBOX, TEXT + (state*3))), guiAlpha));
#else
        GuiDrawText(isVertical ? "#121#" : "#118#", RAYGUI_CLITERAL(RLRectangle){ arrowUpLeft.x, arrowUpLeft.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
            TEXT_ALIGN_CENTER, Fade(GetColor(GuiGetStyle(SCROLLBAR, TEXT + state*3)), guiAlpha));   // ICON_ARROW_UP_FILL / ICON_ARROW_LEFT_FILL
        GuiDrawText(isVertical ? "#120#" : "#119#", RAYGUI_CLITERAL(RLRectangle){ arrowDownRight.x, arrowDownRight.y, isVertical ? bounds.width : bounds.height, isVertical ? bounds.width : bounds.height },
