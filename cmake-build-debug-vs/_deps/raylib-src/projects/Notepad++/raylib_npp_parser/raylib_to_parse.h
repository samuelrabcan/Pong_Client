...
RLAPI void DrawRLRectangleRec(RLRectangle rec, Color color);                                                 // Draw a color-filled rectangle
...
RLAPI void ImageDrawRLRectangleRec(Image *dst, RLRectangle rec, Color color);                                // Draw rectangle within an image
